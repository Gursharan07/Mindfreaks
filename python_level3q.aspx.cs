...
public partial class python_level3q : System.Web.UI.Page
{
    ...
    {
        cn.Open();
        SqlCommand cmd = new SqlCommand("Insert into Python_level3q(question,a,b,c,d,answer) values(@question,@a,@b,@c,@d,@answer)", cn);
        ...
        cmd.ExecuteNonQuery();
        cn.Close();
        Response.Redirect("python_level3q.aspx");
    }
}