<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m1.aspx.cs" Inherits="m1" %>
...
<body>
   ...
   <div class="sunny">
       ...
       <asp:Button class="btn btn-5" ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click1" Height="40px" Width="130px" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mindConnectionString %>" SelectCommand="SELECT [question], [a], [b], [c], [d], [Id] FROM [c_level3q]">
        </asp:SqlDataSource>
            &nbsp;<br />
