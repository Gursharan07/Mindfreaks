...
public partial class java_level1q : System.Web.UI.Page
{
    ...
    {
        cn.Open();
        SqlCommand cmd = new SqlCommand("Insert into java_level1q(question,a,b,c,d,answer) values(@question,@a,@b,@c,@d,@answer)", cn);
        ...
        cmd.ExecuteNonQuery();
        cn.Close();
        Response.Redirect("java_level1q.aspx");
    }
}