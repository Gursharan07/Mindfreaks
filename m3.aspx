<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m3.aspx.cs" Inherits="m3" %>
...
<body>
   ...
   <div class="sunny">
       <br />
       <asp:DataList class="data" ID="DataList1" runat="server" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="DataList1_SelectedIndexChanged" Height="1652px" style="margin-left: 0px; margin-right: 0px" Width="480px">
                   <ItemTemplate>
                      &nbsp; &nbsp;&nbsp;<font color="#A4DE02"> 
                  <div class="ques">    
       ...
       <asp:Button class="btn btn-5" ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click1" />
        </div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mindConnectionString %>" SelectCommand="SELECT [question], [a], [b], [c], [d], [Id] FROM [cpp_level2q]">
        </asp:SqlDataSource>
            &nbsp;<br />
