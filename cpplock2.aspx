<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cpplock2.aspx.cs" Inherits="cpplock2" %>
...
<div class="container">
    ...
    <div class="face face1">
        <div class="content">
            ...
            <p> You need 10 out of 20 score,
                ...
                <br />
               <a href="m2.aspx"> <button class="btn">Lets play</button></a>
            </p>
    ...
    <div class="face face1">
        <div class="content">
            <h2> INTERMEDIATE</h2>
           <i class="fa fa-lock" style="font-size:100px; 
            position:absolute;
            left:62%; bottom:30%;right:50%;"></i>
 <p> Buckle up! questions are getting
                difficult you need to focus
     <br />
        <button class="btn1">Lets play</button></a>
 </p>
        </div>
        </div>
        <div class="face face2">
    ...
    <div class="face face1">
      ...
      <i class="fa fa-lock" style="font-size:100px; 
            position:absolute;
           left:55%; bottom:27%;right:50%;">  </i>
            <p>Your are just one step away to
                become a Mindfreak Can you do it?
              
                 <br />
               <button class="btn2">Lets play</button></a>
              </p>
        </div>
        </div>
        <div class="face face2">
