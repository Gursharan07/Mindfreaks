<%@ Page Language="C#" AutoEventWireup="true" CodeFile="finallevel1.aspx.cs" Inherits="finallevel1" %>
<!Doctype html>
...
<div class="container">
    ...
    <div class="face face1">
        <div class="content">
            ...
            <p> You need 10 out of 20 score,
                ...
                <br />
               <a href="mcq.aspx"> <button class="btn">Lets play</button></a>
            </p>
 ...
 <p> Buckle up! questions are getting
     ...
     <br />
    <a href="mc.aspx">    <button class="btn1">Lets play</button></a>
 </p>
        </div>
        </div>
        <div class="face face2">
