<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m4.aspx.cs" Inherits="m4" %>
...
<body>
    ...
    <div class="top">
        <br />
        <b>
        <h2 style="margin:10px;position:relative;bottom:12px; left: 30px; "> <font>Level 3 : Pro&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;           &nbsp;&nbsp;&nbsp;           &nbsp;&nbsp;&nbsp;Score:                         
   ...
   <div class="sunny">
       <br />
       <asp:DataList class="data" ID="DataList1" runat="server" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="DataList1_SelectedIndexChanged" Height="1956px" style="margin-left: 0px; margin-right: 0px">
                   <ItemTemplate>
                      &nbsp; &nbsp;&nbsp;<font color="#A4DE02"> 
                  <div class="ques">    
       ...
       <asp:Button class="btn btn-5" ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click1" Height="40px" Width="130px" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mindConnectionString %>" SelectCommand="SELECT [question], [a], [b], [c], [d], [Id] FROM [cpp_level3q]">
        </asp:SqlDataSource>
            &nbsp;<br />
...
&nbsp;<p>
        ...
        <asp:Timer ID="Timer1" runat="server" Interval="300000" OnTick="Timer1_Tick1">
        </asp:Timer>
