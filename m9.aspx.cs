...
public partial class m9 : System.Web.UI.Page
{
    ...
    protected void R1_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (rs1.Checked)
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("Select * from it_level2q where answer=@a", cn);
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        if (count >= 10)
        {
            ...
            Response.Redirect("wonit2.aspx");
        }
        else
        {
            Session["Uname"] = Label1.Text;
            Response.Redirect("lostit2.aspx");
