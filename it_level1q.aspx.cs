...
public partial class it_level1q : System.Web.UI.Page
{
    ...
    {
        cn.Open();
        SqlCommand cmd = new SqlCommand("Insert into it_level1q(question,a,b,c,d,answer) values(@question,@a,@b,@c,@d,@answer)", cn);
        ...
        cmd.ExecuteNonQuery();
        cn.Close();
        Response.Redirect("it_level1q.aspx");
    }
}